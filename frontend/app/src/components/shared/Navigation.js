            ...
            <div className='nav-container'>
                ...
                <div className='menu-container'>
                    ...
                    <div className='menu-item'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer2 icon" viewBox="0 0 16 16">
                        ...
                        {
                            usertype === 'employee'
                                ? <Link to={'/empdash'}><p>Dashboard</p></Link>
                                : usertype === 'admin'
                                    ? <Link to={'/admdash'}><p>Dashboard</p></Link>
                                    : null // Render nothing if usertype is neither employee nor admin
                        }
                    </div>
                    ...
                    {usertype === 'admin' && (
                        <div className='menu-item'>
                            ...
                            <Link to={'/managereim'}>Manage Reimbursements</Link>
                        </div>
                    )}
                    ...
                    {usertype === 'admin' && (
                        <div className='menu-item'>
                            ...
                            <Link to={'manageliq'}>Manage Liquidations</Link>
                        </div>
                    )}
